#
# Uses speech_final as the primary flush trigger (only final STT segments normally cause OpenAI calls).
#
# Removes automatic mode detection; only explicit voice commands starting with "switch mode" change the mode.
#
# Shows a brief startup announcement you requested:
# "Quick mode activated. Say 'switch mode medium, switch mode long' if you want long-form speaking."
#
# Fixes TTS playback so audio is streamed to the speaker as chunks arrive (reducing long delays).
#
# Keeps your microphone/STT threading and TTS queue model — no regressions.
#
# Prints exactly what agent speaks (Agent says: ...) for debugging.
#
# Keeps interrupts (stop, wait, hold on, assistant) to stop playback.

# No more direct out_stream.write() calls inside Deepgram’s socket callback — the callback only enqueues bytes. That removes the race where writes happen after the stream was stopped/closed.
#
# A single playback_worker thread opens/closes the PyAudio stream in one place — much safer.
#
# Bounded queue prevents memory blow if Deepgram floods audio; if queue fills, we stop gracefully.
#
# We still stream chunks as they arrive (low latency) — the playback thread writes frequently.
#
# Proper timeouts for done_event and join avoid infinite waits.
...
# C:\Users\bvidh\PycharmProjects\tech_assignment-main\tech_assignment-main\.venv\Scripts\python.exe C:\Users\bvidh\PycharmProjects\tech_assignment-main\tech_assignment-main\main_v9.py
# 2025-12-09 13:28:49,694 - __main__ - INFO - Mode set to 'quick': words=25, seconds=0.9, min_window=0.6
# 2025-12-09 13:28:49,695 - __main__ - INFO - Quick mode activated. Say 'switch mode medium, switch mode long' if you want long-form speaking.
# 2025-12-09 13:28:51,192 - __main__ - INFO - Deepgram STT opened
# 2025-12-09 13:28:51,702 - __main__ - INFO - Deepgram STT connected
# 2025-12-09 13:28:51,702 - __main__ - INFO - Voice assistant running. Say 'switch mode ...' to change modes.
# 2025-12-09 13:28:51,834 - __main__ - INFO - Microphone started. Speak now...
# 2025-12-09 13:28:54,917 - __main__ - INFO - Processing with OpenAI: Hi. How are Hi. How are you doing?
# 2025-12-09 13:28:56,054 - httpx - INFO - HTTP Request: POST https://api.openai.com/v1/chat/completions "HTTP/1.1 200 OK"
# 2025-12-09 13:28:56,329 - __main__ - INFO - Agent says: Hi! I'm doing well, thank you! How about you?
# 2025-12-09 13:28:57,423 - __main__ - INFO - TTS connection opened
# 2025-12-09 13:29:10,325 - __main__ - ERROR - Error writing audio chunk: [Errno -9983] Stream is stopped
# 2025-12-09 13:29:10,325 - __main__ - ERROR - Error writing audio chunk: [Errno -9988] Stream closed
# 2025-12-09 13:29:10,325 - __main__ - ERROR - Error writing audio chunk: [Errno -9988] Stream closed
# 2025-12-09 13:29:10,325 - __main__ - INFO - TTS connection closed